...
-- set metamethods for orderedtable "class"
...
return setmetatable(orderedtable, {__call=orderedtable.new})

--[[ Example Usage:
orderedtable = require"orderedtable"
